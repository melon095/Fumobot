...
<div class="relative overflow-x-auto shadow-md">
    ...
    <div class="relative mt-1">
        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            ...
            <input bind:value={searchTerm} type="text" placeholder="Search by name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 p-2.5 ps-10">
        </div>
    </div>
</div>
