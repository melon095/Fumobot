...
public class IrcHandler
{
    ...
    public async ValueTask Start()
    {
        ...
        var channels = ChannelRepository.GetAll()
            .Where(x => x.GetSettingBool(ChannelSettingKey.ConnectedWithEventsub) == false)
    ...
    private async ValueTask IrcClient_OnMessage(Privmsg privmsg)
    {
        try
        {
            ...
            MessageReceivedCommand message = new ChatMessage(channel, user, input, isBroadcaster, isMod, privmsg.Id);
