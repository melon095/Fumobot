...
namespace Fumo.Database.Migrations
{
    ...
    [Migration("20240331163746_OAuth_Provider_Is_Key")]
    partial class OAuth_Provider_Is_Key
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fumo.Database.DTO.CommandExecutionLogsDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fumo.Database.DTO.CommandExecutionLogsDTO", b =>
                {
                    b.HasOne("Fumo.Database.DTO.ChannelDTO", "Channel")
                        .WithMany()
